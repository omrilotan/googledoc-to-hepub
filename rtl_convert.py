...
def convert_epub_to_rtl(input_file, output_file):
    """Converts an EPUB file to RTL.
    Parameters:
    INPUT_FILE: The path to the EPUB file to convert.
    OUTPUT_FILE: The path to the output EPUB file. If not specified, the input file will be overwritten.
    """
    if output_file == "":
